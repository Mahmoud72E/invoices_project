				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							@can('الاشعارات')
							@php
								$notifi_count = Auth::user()->unreadNotifications->count();
							@endphp
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('read_all')}}"> قراءة الكل</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">لديك ({{$notifi_count}})  غير مقروءه</p>
									</div>
									<div class="main-notification-list Notification-scroll">
										...
										<a class="d-flex p-3 border-bottom" href="{{url('InvoicesDetails')}}/{{$notifications->data['id']}}">
											...
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{$notifications->data['title']}}</h5>
                                                <div class="notification-subtext">بواسطة {{$notifications->data['user']}}</div>
